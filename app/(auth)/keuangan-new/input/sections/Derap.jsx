...
const DerapSection = () => {
  ...
  const checkSavedStatus = async (bulan, tahun) => {
    try {
      const res = await GlobalApi.getRekapDerapByPeriode(bulan, tahun);
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      await GlobalApi.updateDerap(editingRow, payload);
      toast.success("Data Derap berhasil diperbarui!");
      fetchTableData();
      ...
      toast.error("Gagal memperbarui data Derap.");
    } finally {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      toast.success("Data Derap berhasil dihapus!");
      fetchTableData();
    } catch (error) {
  ...
  const handleSaveTable = async () => {
    ...
    try {
      ...
      await GlobalApi.saveRekapDerapBatch(payload);
      toast.success("Rekapitulasi data Derap berhasil disimpan ke database!", {
        id: loadingToast,
      });
      setIsSaved(true);
      ...
      console.error("Error saving rekap derap batch:", error);
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <p className="text-indigo-100 text-[10px] font-medium uppercase tracking-widest">
                Manajemen pesanan dan distribusi majalah Derap
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs font-medium">
                  Manajemen pesanan majalah Derap
                </p>
              </div>
            </div>
          </div>
                        ...
                        .map((row, i) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-4">
                              <span className="px-2 py-0.5 bg-indigo-50 text-indigo-600 rounded-md">
                                {row.jumlah}
                              </span>
                            </td>
                            <td className="px-4 py-4">
        ...
        <AnimatePresence>
          {showEditModal && (
            ...
            >
              ...
              >
                <div className="bg-indigo-500 p-6 text-white flex items-center gap-3">
