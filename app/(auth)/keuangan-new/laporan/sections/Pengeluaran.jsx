...
const PengeluaranSection = () => {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const bulanFormatted = `${selectedYear}-${selectedMonth.padStart(2, "0")}`;
      const res = await GlobalApi.getLaporanPengeluaran(bulanFormatted);
      setData(res.dataTransaksi || []);
    } catch (error) {
  ...
  const exportToExcel = () => {
    ...
    XLSX.writeFile(wb, `Laporan_Pengeluaran_${selectedMonth}_${selectedYear}.xlsx`);
  };
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-rose-100 text-xs font-medium uppercase tracking-wider">Detail seluruh biaya & dana keluar Sanduka</p>
            </div>
          </div>
      ...
      <div className="p-6 space-y-6 flex-1 overflow-y-auto">
        ...
        <div className="bg-rose-50 border border-rose-100 p-6 rounded-[32px] flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h4 className="text-xs font-black text-rose-800 uppercase tracking-widest">Total Pengeluaran</h4>
              <p className="text-[10px] text-rose-600 font-bold">Periode {bulanList.find(b => b.id === selectedMonth)?.namaBulan} {selectedYear}</p>
            </div>
          </div>
