...
const TargetRealisasiOrganisasi = () => {
  ...
  const getRealisasiFromKasOrganisasi = async () => {
    try {
      const bulanAngka = monthMap[selectedBulan];

      const realisasiData = await GlobalApi.getRealisasiFromKasOrganisasi(
        bulanAngka,
        selectedYear,
      );
...
export default TargetRealisasiOrganisasi;
