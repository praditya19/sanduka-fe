      ...
      <div className="max-w-[1400px] mx-auto mb-6 print:hidden">
        <div className="flex items-center justify-between mb-4">
          <button
            ...
            className="flex items-center space-x-2 text-slate-400 hover:text-emerald-600 transition-all font-bold text-[10px] uppercase tracking-widest"
          >
          ...
          <div className="flex items-center space-x-2 bg-white px-3 py-1.5 rounded-full border border-slate-100 shadow-sm">
            ...
            <span className="text-[9px] font-bold text-slate-400 uppercase tracking-[0.2em]">Sanduka Ecosystem v2.0</span>
          </div>
        </div>
          ...
          {menuItems.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-[12px] font-bold text-slate-800 leading-tight">{item.label}</h3>
                  <div className={`mt-0.5 text-[8px] font-bold uppercase tracking-widest ${activeTab === item.id ? 'text-emerald-500' : 'text-slate-400'}`}>
              ...
              <div className={`flex items-center justify-between pt-2 border-t border-slate-50 text-[9px] font-bold ${activeTab === item.id ? 'text-emerald-500' : 'text-slate-500'}`}>
        ...
        <div className="mt-8 print:mt-0">
          {activeTab === "kas" ? (
            ...
            <div className="bg-white rounded-[32px] border border-slate-100 p-8 md:p-16 shadow-2xl shadow-slate-200/50 flex flex-col items-center text-center">
              ...
              <h2 className="text-xl font-bold text-slate-800 mb-2 uppercase tracking-tight">Pilih Modul Laporan</h2>
              ...
              <div className="flex flex-wrap justify-center gap-3">
                <button 
                  ...
                  className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold text-[10px] uppercase tracking-widest shadow-lg shadow-emerald-100 transition-all active:scale-95"
                >
                  Laporan Keuangan
                </button>
                <button 
                  onClick={() => router.push("/keuangan-new/input")}
                  className="px-6 py-3 bg-slate-900 hover:bg-black text-white rounded-xl font-bold text-[10px] uppercase tracking-widest shadow-lg shadow-slate-200 transition-all active:scale-95"
                >
                  Manajemen Input
                </button>
              </div>
            ...
            <div className="bg-white rounded-[32px] border border-slate-100 p-8 shadow-2xl shadow-slate-200/50 min-h-[300px] flex flex-col items-center justify-center text-center">
              ...
              <h2 className="text-xl font-bold text-slate-800 mb-1 uppercase tracking-tight">Modul Pengembangan</h2>
