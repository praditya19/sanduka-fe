    ...
    <div className="w-full p-4 container shadow-lg rounded-lg">
      <div className="rounded-md flex flex-col py-4">
        <div className="container px-2">
          <h2 className="text-lg md:text-xl font-bold mb-4 text-center">REKAP MENINGGAL</h2>
          ...
          <Table className="w-full table-auto mb-8">
            <TableHeader className="p-2 md:p-3 border bg-green-300">
              <TableRow>
                ...
                <TableHead className="text-center font-bold text-gray-800 border text-lg">Date Lapor</TableHead>
                <TableHead className="text-center font-bold text-gray-800 border text-lg">Data Meninggal</TableHead>
                <TableHead className="text-center font-bold text-gray-800 border text-lg">Cabang</TableHead>
                <TableHead className="text-center font-bold text-gray-800 border text-lg">Keterangan</TableHead>
                <TableHead className="text-center font-bold text-gray-800 border text-lg">Diterimakan</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredData.map((item, index) => (
                <TableRow key={index} className={index % 2 === 0 ? "bg-gray-200" : "bg-white"}>
                  ...
                  <TableCell className="text-center border">{item.diterimakan}</TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
