...
function DerapForm() {
  const [provinsi, setProvinsi] = useState(5700);
  const [kabupaten, setKabupaten] = useState(9500);
  const [cabang, setCabang] = useState(1350);
    ...
    <div className="container mx-auto p-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="p-6 rounded-lg shadow-md border border-gray-200 bg-white">
          ...
          <div>
            <h3 className="text-lg font-bold mb-2 text-blue-600">Total:</h3>
            <p className="text-lg text-gray-700">
