...
const Page = () => {
  ...
  const fetchData = async (year) => {
    try {
      const response = await GlobalApi.getLaporanPemasukanTahunan(year); // Panggil API dengan tahun yang dipilih
          ...
          <div className="container mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <h1 className="text-base">
                Laporan Pemasukan Tahunan Sanduka
              </h1>
            </div>
          </div>
        </header>
              ...
              <div className="bg-teal-800 p-2 rounded-lg shadow-lg mt-5">
                <div className="flex flex-col sm:flex-row sm:justify-between items-center mb-4">
                  ...
                  <div className="flex-1 flex justify-center">
                    ...
                    LAPORAN PEMASUKAN TAHUN {selectedYear}
                    </h1>
                  </div>
                    ...
                    {data && data.length > 0 ? (
                      data.map((item, index) => (
                        ...
                        >
                          ...
                          <td className="px-6 py-4 text-sm">{item.namaBulan}</td>
