    ...
    const onSignIn = async () => {
        ...
        try {
            ...
            if (/^\d{10,11}$/.test(email)) {
                ...
                const loginData = { npaPgri: email, tanggalLahir: password };
                        ...
                        <div className="p-6 sm:p-8">
                            ...
                            <div className="flex flex-col items-center">
                                <Image
                                    ...
                                    alt="logo"
                                />
                                <h2 className="font-bold text-xl sm:text-2xl mt-3">
                                    Masuk ke Akun
                                </h2>
                            ...
                            <div className="mt-6 space-y-5">
                                ...
                                <div>
                                    <Label htmlFor="modal-email" className="block text-sm">
                                        User
                                    </Label>
                                    <Input
                                        id="modal-email"
                                        ...
                                        className="mt-2 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-teal-500 w-full"
                                    />
                                </div>

                                <div className="relative">
                                    <Label htmlFor="modal-password" className="block text-sm">
                                ...
                                <Button
                                    ...
                                    className="w-full flex justify-center items-center bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-700 hover:to-emerald-700 text-white rounded-lg py-2.5 transition-all duration-200"
                                >
                                    {loader ? (
