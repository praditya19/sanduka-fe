  ...
  return (
    <div className="bg-gray-100 py-12">
      <div className="container mx-auto px-4 md:px-12 lg:px-24">
        <h2 className="text-2xl font-bold mb-8 text-center">Tentang</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-lg card">
            <div className="flex items-center mb-2">
              <Image
                ...
                className="mr-2"
              />
              <h4 className="text-lg font-bold">APA ITU SANDUKA</h4>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 transform transition-all duration-300 hover:scale-105 hover:shadow-lg card">
            <div className="flex items-center mb-2">
              <Image
                ...
                className="mr-2"
              />
              <h4 className="text-lg font-bold">BERAPA SUMBANGAN ANGGOTA?</h4>
            </div>
            <p className="text-gray-700 text-base text-justify">
